...
import { TestCases } from '../../Exercises/Exercises';
import AddExerciseModal from './AddExerciseModal';

const ExercisesTable = observer(({ groupId }: { groupId: any }) => {
                ...
                return (
                    <div className="actions-row cell" onClick={(e) => e.stopPropagation()} data-tourid="table-actions">
                        ...
                        <ProtectedElement acceptRoles={['INSTRUCTOR']}>
                            ...
                            <TooltipWrapper tooltipText="Gỡ khỏi nhóm" position="left">
                                <Popconfirm
                                    // title="Are you sure you want to delete this exercise?"
                                    title="Bạn có chắc chắn muốn gỡ bài tập này khỏi nhóm?"
                                    okText="Có"
                                    cancelText="Không"
                                    onConfirm={() => {
                                        http.deleteCc(`/groups/${groupId}/exercises`, [record.id]).then((res) => {
    ...
    const getGroupExercises = () => {
        if (groupId) {
            setLoading(true);
            http.get(`/groups/${groupId}/exercises`).then((res) => {
                setDatas(res.data);
            ...
            globalStore.triggerNotification('error', 'Không tìm thấy thông tin nhóm', '');
        }
    };
    ...
    return (
        <div className={classnames('leetcode', globalStore.isBelow1300 ? 'col' : 'row')}>
            <div className={classnames('exercises left', { 'pr-16': globalStore.windowSize.width > 1300 })}>
                <Modal
                ...
                >
                    <div className="filters">
                        ...
                        <TooltipWrapper tooltipText="Bộ lọc" position="right">
                            <Popover
                                content={
